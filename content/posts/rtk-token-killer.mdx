...
<img src="/content/rtk/rtk-init.png" alt="rtk init 실행 결과" style={{width: '100%'}} />
...
**실제 hands-on 해봤을 때**:
![RTK 적용 후 claude git 실행 비교](/content/rtk/claude-git-command-req.png)
![RTK 적용 후 토큰 효율성](/content/rtk/rtk-before-after.png)
